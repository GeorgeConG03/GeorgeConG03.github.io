...
// Obtener todas las reseñas de libros
$sql = "SELECT r.id_resena, r.titulo, r.calificacion, r.imagenes, r.paginas, 
        r.archivo_php, r.id_usuario, r.descripcion, u.nombre as autor 
        FROM resenas r 
        LEFT JOIN usuarios u ON r.id_usuario = u.id_usuario 
        WHERE r.categoria = 'libro' 
        ORDER BY r.fecha_creacion DESC";
$result = $conexion->query($sql);

$page_title = "Reseñas de Libros - Full Moon, Full Life";
...
<div class="listado-container">
    <div class="listado-header">
        <h1 class="listado-title">RESEÑAS DE LIBROS</h1>
    </div>
    
    <div class="buscador">
        <input type="text" id="buscar-libro" placeholder="Buscar libro..." aria-label="Buscar libro">
    </div>
        
    <?php if (is_logged_in()): ?>
    <a href="crear-resena.php" class="crear-libro-btn">CREAR NUEVA RESEÑA DE UN LIBRO</a>
    <?php endif; ?>
