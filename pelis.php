...
// Obtener todas las reseñas de películas
$sql = "SELECT r.id_resena, r.titulo, r.calificacion, r.imagenes, r.duracion, 
        r.archivo_php, r.id_usuario, r.descripcion, u.nombre as autor 
        FROM resenas r 
        LEFT JOIN usuarios u ON r.id_usuario = u.id_usuario 
        WHERE r.categoria = 'pelicula' 
        ORDER BY r.fecha_creacion DESC";
$result = $conexion->query($sql);

$page_title = "Reseñas de Películas - Full Moon, Full Life";
...
<div class="listado-container">
    <div class="listado-header">
        <h1 class="listado-title">RESEÑAS DE PELÍCULAS</h1>
    </div>
    
    <div class="buscador">
        <input type="text" id="buscar-pelicula" placeholder="Buscar película..." aria-label="Buscar película">
    </div>
        <?php if (is_logged_in()): ?>
    <a href="crear-resena.php" class="crear-peli-btn">CREAR NUEVA RESEÑA DE UNA PELÍCULA</a>
    <?php endif; ?>
    ...
    <!-- Nuevo mensaje cuando SÍ hay reseñas -->
    <div class="no-contenido" style="margin-top: 3rem; text-align: center;">
        <p>¿Quieres aportar algo nuevo? ¡CREA UNA RESEÑA!</p>
        <a href="crear-resena.php" class="comic-button">CREAR RESEÑA</a>
    </div>
<?php else: ?>
    <!-- Mensaje cuando NO hay reseñas (se mantiene igual) -->
    <div class="no-contenido">
        <p>No hay reseñas de libros disponibles.</p>
...
document.addEventListener('DOMContentLoaded', function() {
    const buscarInput = document.getElementById('buscar-pelicula');
